...
export const LESSONS: Lesson[] = [
  ...
  {
    day: "十二", title: "的、地、得不要混", focus: "的＋名词／地＋动作／得＋程度", focusEn: "的 + Noun / 地 + Action / 得 + Degree",
    sentence: "小华用力地把球扔出去，球飞得很高，落在了远处的草地上。",
    chunks: ["小华用力地", "把球扔出去，", "球飞得很高，", "落在了远处的草地上。"], mixed: [1, 3, 0, 2],
    labels: ["动作方式", "动作", "动作程度", "地点"], labelsEn: ["How", "Action", "Degree", "Place"],
    pattern: "怎样地＋做动作／动作得＋怎样／怎样的＋名词", patternEn: "How + 地 + Action / Action + 得 + Degree / Description + 的 + Noun", patternKeys: ["地", "得", "的"],
    prompt: "选择‘的、地、得’填空：他开心＿笑了；他跑＿很快；这是他最喜欢＿故事。",
    variations: ["弟弟小心地捧着装满水的杯子。", "雨下得很大，我们只好留在室内。", "妹妹认真地读着一本有趣的故事书。"],
  },
  {
